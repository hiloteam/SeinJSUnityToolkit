...
namespace SeinJS
{
	public class GlTFUI
	{
		...
		public GUIStyle GlTFButton;
		public GUIStyle GlTFLabel;
		...
		private void Initialize()
		{
			...
			GlTFButton = new GUIStyle(EditorStyles.miniButton);
			GlTFButton.font = OSSemiBold;
			GlTFButton.fontSize = 11;
			GlTFButton.fixedHeight = 24;

			GlTFLabel = new GUIStyle(EditorStyles.miniLabel);
			GlTFLabel.richText = true;
		}
		...
		{
			return "<color=" + GlTFUI.CLICKABLE_COLOR + ">" + text + "</color>";
		}

		public static string ErrorTextColor(string text)
		{
			return "<color=" + GlTFUI.ERROR_COLOR + ">" + text + "</color>";
		}
	}
}
#endif