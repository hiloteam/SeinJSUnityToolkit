 ...
 * @Description: main.
 */
var Sein = __webpack_require__(/*! seinjs */ "./node_modules/_seinjs@1.4.38@seinjs/lib/seinjs.umd.js");
...
function BasicMaterial(_a) {
    ...
    return new Sein.BasicMaterial(__assign({ lightType: lightType, diffuse: (uniforms.u_diffuseMap || uniforms.u_diffuse || {}).value, ambient: (uniforms.u_ambientMap || {}).value, specular: (uniforms.u_specularMap || uniforms.u_specular || {}).value, normalMap: (uniforms.u_normalMap || {}).value, normalMapScale: (uniforms.u_normalMapScale || {}).value, emission: (uniforms.u_emissionMap || uniforms.u_emission || {}).value, shininess: (uniforms.u_shininess || {}).value, reflectivity: (uniforms.u_reflectivity || {}).value, refractivity: (uniforms.u_refractivity || {}).value, refractRatio: (uniforms.u_refractRatio || {}).value }, opts));
}
Sein.BasicMaterial.prototype.initCommonOptions = function () { };
Sein.MetaSMaterials['BasicMaterial'] = BasicMaterial;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    console.log(game.resource.get(name_1));
                    _b.label = 3;
                case 3:
                    index += 1;
                    return [3 /*break*/, 1];
